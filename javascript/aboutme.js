...
$(window).scroll( () => {
  ...
  if(($(window).scrollTop()/($(window).height()/3)) > 1.2 && $(".section-skills").css("display") == "flex") {
      $(".skill-bubble-container").css({
        "transform" : "translatex("+ ((($(window).scrollTop()/($(window).height()/3))-1.2)*$(window).width()*0.6) +"px)",
        "opacity" : 1-((($(window).scrollTop()/($(window).height()/3))-1.2)*1.5)
      })
      $(".skill-info").css({
        "transform" : "translatex("+ -((($(window).scrollTop()/($(window).height()/3))-1.2)*$(window).width()*0.6) +"px)",
        "opacity" : 1-((($(window).scrollTop()/($(window).height()/3))-1.2)*1.5)
